...
pwd ----------> present working directory | the Folder we're currently in

mkdir ---------> make directory | make/create a new Folder
...
ls -a -------------> list clearly of both hidden && unhidden Files
...
top | htop ---------> show memory and cpu usage 
